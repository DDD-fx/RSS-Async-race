...
export const MAX_GENERATED_CARS = 100;
...
export const CAR_MODELS: string[] = ['Durango', 'Ram', 'Challenger', 'Charger', 'Grand Caravan', 'X7', 'X5', 'X3', 'X6 M', 'X6', 'X1', 'X4', 'C3 Aircross', 'C5 Aircross', 'Duster', 'CR-V', 'Corolla',
...
export const DRIVE_ERRORS: DriveErrorsType = {
